...
//     this.insuranceStartDateInput = page.locator("//input[@placeholder='Enter Insurance Start Date']");
//     this.insuranceRenewalDateInput = page.locator("//input[@placeholder='Enter Insurance Renewal Date']");
...
//     await this.vehicleTypeDropdown.selectOption(String(data.vehicleType));

//     await this.registrationDateInput.fill(data.registrationDate);
//     await this.taxRenewalDateInput.fill(data.taxRenewalDate);
//     await this.rcCopyInput.setInputFiles(data.rcCopy);
//     await this.activeCheckbox.check();
//     await this.POCCopyInput.setInputFiles(data.POCCopy);
...
//     await this.InsuranceCopyInput.setInputFiles(data.InsuranceCopy);
